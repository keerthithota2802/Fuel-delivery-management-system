<?php
if(isset($_GET['delfpid']))
{
$rid=intval($_GET['delfpid']);
...
$query="select * from tblfuelprice";
...
<table align="center" border="1px" style="width:850px; line-height:40px;"> 
	<tr> 
		<th colspan="8"><h2>Manage Fuel Price</h2></th> 
		</tr> 
			  <th> ID </th> 
			  <th> Type Of Fuel </th> 
		...
		<td><?php echo $rows['Typeoffuel']; ?></td>
		<td><?php echo $rows['TodayFuelprice']; ?></td>
		<td style="width:80px"><center><a href="editfp.php?editfpid=<?php echo ($rows['ID']);?>" class="edit" style="text-decoration:none">Edit</a></center></td>
		<td style="width:80px"><center><a href="managefp.php?delfpid=<?php echo ($rows['ID']);?>"  onclick="return confirm('Do you really want to Delete ?');"
