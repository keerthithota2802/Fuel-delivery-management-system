...
<div class="maindiv">
<div class="subdiv">
<center><h2>Update State</h2></center>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspState<br><br>
<form bgcolor="white" action="edit_state.php">
<?php 
$con=mysqli_connect("localhost","root","","fdms");
$id=$_GET['editstateid'];
$sql="select State from tblstate where ID='$id'";
$sql=mysqli_query($con,$sql);
$result=mysqli_fetch_assoc($sql);
$_SESSION['editstateid']=$id;
?>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="state" value="<?php echo $result['State']; ?>">
<br>
