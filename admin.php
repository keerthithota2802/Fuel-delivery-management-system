...
&nbsp&nbsp Total Reg Users
<?php 
$con=mysqli_connect("localhost","root","","fdms");
$sql="select count(Name) as c from tbluser";
$r=mysqli_query($con,$sql);
$r=mysqli_fetch_assoc($r);
$r=$r['c'];
echo "<h3>&nbsp&nbsp&nbsp&nbsp&nbsp".$r."</h3>";
?>
&nbsp&nbsp&nbsp&nbsp<a href="reg_users.php" style="text-decoration:none;font-size:20px;color:black;">ViewDetail</a>
</div>
<div class="newfuelorder">
&nbsp&nbspTotal Reg Owners
<?php 
$con=mysqli_connect("localhost","root","","fdms");
$sql="select count(Name) as c from tblfuelstationowner";
$r=mysqli_query($con,$sql);
$r=mysqli_fetch_assoc($r);
$r=$r['c'];
echo "<h3>&nbsp&nbsp&nbsp&nbsp&nbsp".$r."</h3>";
?>
&nbsp&nbsp&nbsp&nbsp<a href="regfuelstationowner.php" style="text-decoration:none;font-size:20px;color:black;">ViewDetail</a>
</div>
<div class="Confirmedorder">
&nbsp&nbspTotal State
<?php 
$con=mysqli_connect("localhost","root","","fdms");
$sql="select count(State) as c from tblstate";
$r=mysqli_query($con,$sql);
$r=mysqli_fetch_assoc($r);
$r=$r['c'];
echo "<h3>&nbsp&nbsp&nbsp&nbsp&nbsp".$r."</h3>";
?>
&nbsp&nbsp&nbsp&nbsp<a href="managestate.php" style="text-decoration:none;font-size:20px;color:black;">ViewDetail</a>
</div>
<div class="Cancelledorder">
&nbsp&nbspTotal City
<?php 
$con=mysqli_connect("localhost","root","","fdms");
$sql="select count(City) as c from tblcity";
$r=mysqli_query($con,$sql);
$r=mysqli_fetch_assoc($r);
$r=$r['c'];
echo "<h3>&nbsp&nbsp&nbsp&nbsp&nbsp".$r."</h3>";
?>
&nbsp&nbsp&nbsp&nbsp<a href="managecity.php" style="text-decoration:none;font-size:20px;color:black;">ViewDetail</a>
</div>
</div>
</body>
</html>