<?php
if(isset($_GET['delcityid']))
{
$rid=intval($_GET['delcityid']);
...
$sql="SELECT tblstate.ID as sid,tblstate.State,tblcity.City,tblcity.ID as cid from tblstate join tblcity on tblstate.ID=tblcity.Stateid";
...
<table align="center" border="1px" style="width:850px; line-height:40px;"> 
	<tr> 
		<th colspan="8"><h2>Manage city</h2></th> 
		</tr> 
			  <th> ID </th> 
			  <th> State </th> 
			  <th>City</th>
		...
		{ 
		?> 
		<tr> <td><?php echo $rows['cid']; ?></td>  
		<td><?php echo $rows['State']; ?></td>
		<td><?php echo $rows['City']; ?></td>
		<td style="width:80px"><center><a href="editcity.php?editcityid=<?php echo ($rows['cid']);?>" class="edit" style="text-decoration:none">Edit</a></center></td>
		<td style="width:80px"><center><a href="managecity.php?delcityid=<?php echo ($rows['cid']);?>"  onclick="return confirm('Do you really want to Delete ?');"
