...
$sql="select State from tblstate";
...
<div class="maindiv">
<div class="subdiv">
<center><h2>Add City</h2></center>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspState<br><br>
<form bgcolor="white" action="add_city.php">
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<select name="state" class="state">
...
<br><br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspCity<br><br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" class="city" name="city">
<br><br>
<center><button type="submit" class="submit">Add</button></center>
</form>
</div>
</div>
</body>
