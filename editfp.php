...
<div class="maindiv">
<div class="subdiv">
<center><h2>UPDATE FUEL PRICE</h2></center>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspState<br><br>
<form bgcolor="white" action="edit_fp.php">
<?php 
$con=mysqli_connect("localhost","root","","fdms");
$id=$_GET['editfpid'];
$sql="select * from tblfuelprice where ID='$id'";
$sql=mysqli_query($con,$sql);
$result=mysqli_fetch_assoc($sql);
$_SESSION['editfpid']=$id;
?>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspType of Fuel <br><br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="typefp" value="<?php echo $result['Typeoffuel']; ?>"><br><br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspToday Fuel Price<br><br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="todayfp" value="<?php echo $result['TodayFuelprice']; ?>">
<br><br>
