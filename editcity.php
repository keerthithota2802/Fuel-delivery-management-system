...
<div class="maindiv">
<div class="subdiv">
<center><h2>Update city</h2></center>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspState<br><br>
<form bgcolor="white" action="edit_city.php">
<?php 
$con=mysqli_connect("localhost","root","","fdms");
$id=$_GET['editcityid'];
$sql="select City,Stateid from tblcity where ID='$id'";
$sql=mysqli_query($con,$sql);
$result=mysqli_fetch_assoc($sql);
$_SESSION['editcityid']=$id;
$sid=$result['Stateid'];
$sql1="select State from tblstate where ID='$sid'";
$sql1=mysqli_query($con,$sql1);
$res=mysqli_fetch_assoc($sql1);
?>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<select name="state">
<option><?php echo $res['State']; ?></option>
</select><br><br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspCity<br><br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="city" value="<?php echo $result['City']; ?>">
<br>
