...
<tbody>
<?php
$sql="SELECT tbluser.Name,tbluser.MobileNumber,tbluser.Email, tblorderfuel.ordernum,tblorderfuel.OrderDate,tblfuelstation.NameoffuelStation,tblorderfuel.ID as orderid, tblorderfuel.UserID,tblorderfuel.Status from  tblorderfuel join tbluser on tbluser.ID= tblorderfuel.UserID
...
<?php } else { ?>                  <td><?php  echo $row['Status'];?>
                  ...
                  <td><?php  echo $row['OrderDate'];?></td>
                                        ...
                                        <td><a class="edit" href="ownervieworderdetail.php?editid=<?php echo $row['orderid'];?>&&oid=<?php echo $row['ordernum'];?>">View</a></td>
                        </tr>
