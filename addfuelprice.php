...
<div class="maindiv">
<div class="subdiv">
<center><h2>Add Fuel Price</h2></center>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspType Of Fuel<br><br>
<form bgcolor="white" action="add_fp.php">
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="typefp">
<br><br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspToday Fuel Price <br><br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="fp">
